...
| 03 | `assets/divination/03-horoscope-wheel.png` | ホロスコープ結果の天球儀(SVG出生図の下に敷く) | `--asset-horoscope-wheel` |
| 04 | `assets/divination/04-tarot-back.png` | タロットの裏面 | `--asset-tarot-back`(未配置時は `images/tarot/tarot_back.webp`) |
